...
const NoteList = ({availableTags,notes, onUpdateTag, onDeleteTag}: NoteListProps) => {
  ...
  return (
    <>
     ...
     <EditTagsModal show={modalIsOpen} availableTags={availableTags} onUpdateTag={onUpdateTag} onDeleteTag={onDeleteTag} handleClose={()=>setModalIsOpen(false)}/>
    </>
  )
}
...
const EditTagsModal = ({availableTags,onUpdateTag,show,onDeleteTag,handleClose}:EditTagsModalProps) => {
     return (
